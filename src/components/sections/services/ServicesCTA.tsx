...
export const ServicesCTA: React.FC<ServicesCTAProps> = ({ isMobile }) => {
  ...
  return (
    ...
    >
      <h2
        style={{
          fontWeight: 900, fontSize: isMobile ? '1.8rem' : '2.6rem',
          letterSpacing: '-0.03em', color: isDark ? '#fff' : '#0a0a0a',
      ...
      <motion.a
        ...
        style={{
          ...
          fontWeight: 700, fontSize: '0.95rem', borderRadius: 10,
